...
_.is.shopify.synthesize = d => _.is.Integer(d) || _.is.String(d) || _.is.JSON(d)
_.is.shopify.data = d => _.is.JSON(d)

_.is.shopify.product = d => _.is.JSON(d) && d.id
_.is.shopify.location = d => _.is.JSON(d) && d.id
_.is.shopify.inventory_item = d => _.is.JSON(d) && d.id
_.is.shopify.variant = d => _.is.JSON(d) && d.id && d.product_id
_.is.shopify.image = d => _.is.JSON(d) && d.id && d.product_id
_.is.shopify.inventory_level = d => _.is.JSON(d) && d.location_id && d.inventory_item_id
